...
public class BotInventory implements IInventory, INameable {
    ...
    public final BotEntity player;
    private ItemStack itemStack = ItemStack.EMPTY;
    private int timesChanged;

    public BotInventory(BotEntity playerIn) {
     ...
     */
    public void copyInventory(net.minecraft.entity.player.PlayerInventory playerInventory) {
